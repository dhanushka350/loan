...
<body onload="MEM_GROUP.allGroups();" class="sidebar-xs has-detached-left">
<!-- Main navbar -->
            ...
            <div class="page-header page-header-default">
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/view_borrowers">Borrower</a></li>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="panel panel-flat">
                        <table class="table datatable-dom-position" id="tbl_borrower_group">
                            <thead>
                            <tr>
